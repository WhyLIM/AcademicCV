 ...
 * @LastEditTime: 2025-07-15 15:41:38
  ...
  <div class="academic-cv">
    ...
    <section id="skills" class="section skills-section">
      <div class="inner-container">
        ...
        <el-row :gutter="70">
          <el-col :xs="24" :sm="12" :md="12" class="avatar-col">
    ...
    <section id="projects" class="section projects-section">
      <div class="inner-container">
        ...
        <el-row :gutter="20" v-if="!loading && !error">
          <el-col :xs="24" :sm="12" :md="8" v-for="(project, index) in paginatedProjects" :key="index" class="project-col">
